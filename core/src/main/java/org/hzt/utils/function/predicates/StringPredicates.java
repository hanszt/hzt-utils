...
public final class StringPredicates {
    ...
    public static <T> Predicate<T> startsWith(final Function<? super T, String> toStringMapper, final String string) {
    ...
    public static <T> Predicate<T> contains(final String string, final Function<? super T, String> toStringMapper) {
        return t -> {
    ...
    public static <T> Predicate<T> doesntContain(final String other, final Function<? super T, String> toStringMapper) {
