...
public interface Collectable<T> extends IndexedIterable<T> {
    ...
    default <A, R> R collect(final Supplier<A> supplier,
        ...
        return collect(supplier, unused -> true, e -> e, unused -> true, accumulator, finisher);
    }
    ...
    default <A, R> A collect(final Supplier<A> supplier,
        ...
        return collect(supplier, filter, mapper, unused -> true, accumulator, e -> e);
    }
    ...
    default <C extends Collection<T>> C to(final Supplier<C> collectionFactory) {
        return IterableXHelper.mapFilteringTo(this, collectionFactory, unused -> true, e -> e, unused -> true);
    }
    ...
    default MutableSetX<T> toMutableSet() {
        return IterableXHelper.mapFilteringTo(this, MutableSetX::empty, Objects::nonNull, e -> e, unused -> true);
    }
    ...
    default <R, C extends Collection<R>> C mapTo(final Supplier<C> collectionFactory,
        ...
        return IterableXHelper.mapFilteringTo(this, collectionFactory, Objects::nonNull, mapper, unused -> true);
    }
    ...
    default <C extends Collection<T>> C filterTo(final Supplier<C> collectionFactory,
        ...
        return IterableXHelper.mapFilteringTo(this, collectionFactory, predicate, e -> e, unused -> true);
    }
