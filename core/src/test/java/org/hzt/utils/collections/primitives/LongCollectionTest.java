...
class LongCollectionTest {
    ...
    void longCollectionMap() {
        final LongListX longs = LongList.of(1, 2, 3, 4, 5, 4, 3, 234).map(l -> l * 2);
    ...
    void longCollectionFilter() {
        final LongListX longs = LongList.of(1, 2, 3, 4, 5, 4, 3, 234).filter(l -> l > 4);
    ...
    void longCollectionContainsAllInArray() {
        ...
        final LongListX longListX = LongSequence.generate(0, l -> ++l).take(4_000).toList();
