...
class EntryIterableTest {
    ...
    void testEntryIterableAny() {
        final boolean anySubsequentEqual = Sequence.of(1, 2, 3, 4, 4, 5, 6, 7)
                .zipWithNext()
                .any(Objects::equals);
    ...
    void testEntryIterableNone() {
        final boolean noSubsequentEqual = Sequence.of(1, 2, 1, 4, 5, 6, 7, 10)
                .zipWithNext()
                .none(Objects::equals);
    ...
    void testEntryIterableAll() {
        final boolean isSorted = Sequence.of(1, 2, 3, 4, 4, 5, 6, 7)
                .zipWithNext()
