...
public final class GraphIterators {
    ...
    public static <S extends TreeNode<S>> Iterator<S> treeNodeBreadthFirstIterator(final S source) {
    ...
    public static <S extends TreeNode<S>> Iterator<DepthToTreeNode<S>> treeNodeDepthFirstDepthTrackingIterator(final S source) {
        return new TreeNodeDepthFirstDepthTrackingIterator<>(source);
    }

    public static <S extends Node<S>> Iterator<S> breadthFirstIterator(final S s, final boolean setPredecessor) {
        return new BreadthFirstIterator<>(s, setPredecessor);
    }

    public static <S extends Node<S>> Iterator<S> depthFirstIterator(final S s, final boolean setPredecessor) {
